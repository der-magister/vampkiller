...
vampkiller.gb:	fonttiles.o tsprites.o title.o gameborder.o textborder.o texte.o others.o rooms.o globals.o cdesign.o init.o engine.o player.o gegner.o text.o level.o umgebung.o aktionen.o vampkiller.o
