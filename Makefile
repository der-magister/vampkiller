...
clean:		
		rm -rf obj/* bin/*.cdb bin/*.ihx bin/*.map bin/*.noi
...
others.o:	gfx/others/others.c
		$(CC) -c -o obj/others.o gfx/others/others.c
...
vampkiller.gb:	fonttiles.o tsprites.o gameborder.o textborder.o texte.o others.o rooms.o globals.o cdesign.o init.o engine.o player.o gegner.o text.o level.o umgebung.o aktionen.o vampkiller.o

		$(CC) -Wl-ya1B -Wm-yn"VAMPKILLER" -Wl-yt0x019  -o bin/vampkiller.gb obj/fonttiles.o obj/tsprites.o obj/gameborder.o obj/texte.o obj/others.o obj/textborder.o obj/rooms.o obj/globals.o obj/cdesign.o obj/init.o obj/engine.o obj/player.o obj/gegner.o obj/text.o obj/level.o obj/umgebung.o obj/aktionen.o obj/vampkiller.o
