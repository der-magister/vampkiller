...
extern uint8_t v_kolitimer;				//Timer für Kolision zwischen Spieler und Gegner
...
//umgebung
extern uint8_t v_kiste [8];				//Kisten offen True / false
extern uint8_t v_tuer [3];				// Tuer offen true / false

extern uint8_t v_tmp;
