...
extern void p_engine_loadSpriteset (uint8_t l_fsprite, uint8_t l_lsprite, unsigned char l_spriteset [5]) __nonbanked;
extern void p_engine_loadMap (unsigned char l_lvldat [252]) __nonbanked;
extern void p_engine_showMap (unsigned char l_lvldat [252]) __nonbanked;
